      ...
      try {
        ...
        if(status == PermissionStatus.granted){
          for (var i = 0 ; i < info.phoneNumbers.length ; i ++) {
            final String result = await platform.invokeMethod('send',<String,dynamic>{"phone":"+1${info.phoneNumbers[i]}","msg":"${info.textMessage}"}); //Replace a 'X' with 10 digit phone number
            print(result);
          }
        }
